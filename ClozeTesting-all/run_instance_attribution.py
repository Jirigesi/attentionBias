...
def getInstanceSyntaxAttributionScore(codes, tokenizer, syntaxList):
    ...
    finalyResult = {}
    print("Extracting below syntax types:")
    for syntaxType in syntaxList:
        print(syntaxType)
        finalyResult[syntaxType] = []
            ...
            try:
                ...
                for syntaxType in syntaxList:
                    ...
                    if np.array(attribution_scores).shape[2] != 0:
                        finalyResult[syntaxType].append(np.array(attribution_scores))
...
if __name__ == '__main__':
    ...
    # number_of_samples = 1 # a small set of data for testing
    ...
    syntax_atten_sum_correct_file = 'results/syntax_attribution_instance_correct3.pkl'
    with open(syntax_atten_sum_correct_file, 'wb') as f:
        pickle.dump(correct_attributions, f)
        
    syntax_atten_sum_misprediction_file = 'results/syntax_attribution_instances_misprediction3.pkl'
