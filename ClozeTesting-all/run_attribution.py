...
if __name__ == '__main__':
    ...
    number_of_samples = 10000 # a small set of data for testing
    ...
    syntax_list = ['annotation', 'basictype', 'boolean', 
          ...
          'string', 'decimalfloatingpoint', '[MASK]']
    ...
    for syntax in syntax_list:
        ...
        correct_avg_attns[syntax], correct_syntax_frequenct[syntax] = getSyntaxAttributionScore(correct_codes, 
                                                                                              tokenizer, 
                                                                                              syntax)
    ...
    for syntax in syntax_list:
        ...
        mispredict_avg_attns[syntax], mispredict_syntax_frequenct[syntax] = getSyntaxAttributionScore(mispredic_codes, 
                                                                                                    tokenizer, 
                                                                                                    syntax)
    ...
    syntax_atten_sum_correct_file = 'results/syntax_attribution_correct.pkl'
    with open(syntax_atten_sum_correct_file, 'wb') as f:
        pickle.dump(correct_avg_attns, f)
        
    syntax_atten_sum_misprediction_file = 'results/syntax_attribution_misprediction.pkl'
    with open(syntax_atten_sum_misprediction_file, 'wb') as f:
        pickle.dump(mispredict_avg_attns, f)