            ...
            try: 
                ...
                for syntaxType in syntaxList:
                    ...
                    if np.array(attention_weights).shape[2] != 0:
                        finalyResult[syntaxType].append(np.array(attention_weights))
...
if __name__ == '__main__':
    ...
    syntax_atten_correct_file = 'results/syntax_attention_correct3.pkl'
    with open(syntax_atten_correct_file, 'wb') as f:
        pickle.dump(correct_attention_weights, f)
        
    syntax_atten_sum_misprediction_file = 'results/syntax_attention_misprediction3.pkl'
